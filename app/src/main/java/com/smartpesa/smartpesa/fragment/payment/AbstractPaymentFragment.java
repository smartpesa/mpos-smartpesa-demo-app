...
public abstract class AbstractPaymentFragment extends BaseFragment implements View.OnClickListener {
    ...
    @BindView(R.id.amount_PAYMENT_ET) EditText amountPaymentET;
    @BindView(R.id.cashBack_ET) EditText cashBackAmountET;
    @BindView(R.id.currencyLabel_PAYMENT_TV) TextView currencyLabelTV;
    @BindView(R.id.cashBackCurrencyLabelTV) TextView cashBackCurrencyLabelTV;
    @BindView(R.id.one_PAYMENT_BTN) Button oneBTN;
    @BindView(R.id.two_PAYMENT_BTN) Button twoBTN;
    @BindView(R.id.three_PAYMENT_BTN) Button threeBTN;
    @BindView(R.id.four_PAYMENT_BTN) Button fourBTN;
    @BindView(R.id.five_PAYMENT_BTN) Button fiveBTN;
    @BindView(R.id.six_PAYMENT_BTN) Button sixBTN;
    @BindView(R.id.seven_PAYMENT_BTN) Button sevenBTN;
    @BindView(R.id.eight_PAYMENT_BTN) Button eightBTN;
    @BindView(R.id.nine_PAYMENT_BTN) Button nineBTN;
    @BindView(R.id.zero_PAYMENT_BTN) Button zeroBTN;
    @BindView(R.id.plus_PAYMENT_BTN) Button plusBTN;
    @BindView(R.id.minus_PAYMENT_BTN) Button minusBTN;
    @BindView(R.id.equal_PAYMENT_BTN) Button equalBTN;
    @BindView(R.id.clear_PAYMENT_BTN) Button clearBTN;
    @BindView(R.id.backSpace_PAYMENT_BTN) ImageButton backSpaceBTN;
    @BindView(R.id.continue_PAYMENT_BTN) Button continueBTN;
    @BindView(R.id.alipayScanBtn) Button alipayScanBtn;
    @BindView(R.id.alipayPayBtn) Button alipayPayBtn;

    @BindView(R.id.amountSelectedRL) RelativeLayout amountSelectedRL;
    @BindView(R.id.cashBackSelectedRL) RelativeLayout cashBackSelectedRL;
    @BindView(R.id.amount_PAYMENT_RL) RelativeLayout amountRL;
    @BindView(R.id.alipayContinueLl) LinearLayout alipayButtonsLl;
